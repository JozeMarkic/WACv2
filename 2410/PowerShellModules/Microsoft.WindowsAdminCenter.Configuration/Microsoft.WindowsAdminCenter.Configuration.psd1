@{
    ...
    RootModule        = 'Microsoft.WindowsAdminCenter.Configuration.psm1'
ModuleVersion = '2.4.0.0'
    GUID              = '4fd42196-1db4-4fe9-b473-181d2650b60c'
    Author            = 'Microsoft'
    CompanyName       = 'Microsoft Corporation'
    Copyright         = '(c) 2023 Microsoft Corporation. All rights reserved.'
    Description       = 'The Configuration tool set of Windows Admin Center'
    ...
    FunctionsToExport = @(
        'Add-WACCertificates',
        'Add-WACUserSIDToSecurityDescriptor',
        'Add-WACSetupStartMenuShortcut',
        'Add-WACSideloadSite',
        ...
        'Test-WACClusterRole',
        'Test-WACInstalled',
        'Test-WACInstallationFailure',
        'Test-WACService',
        'Test-WACUninstallKey',
        'Update-WACHARole',
        'Unregister-WACAccountManagementService',
        'Unregister-WACClusterScheduledTask',
        ...
        'Update-WACPSModulePath',
        'Update-WACHAAppSettings')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags       = @('WAC', 'Windows Admin Center')

            # A URL to the license for this module.
            # LicenseUri = ''

            # A URL to the main website for this project.
            ProjectUri = 'https://www.microsoft.com'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBuFfLUVnsk6Q/O
# HVvnCIqLaF30sk9vZ0RaCmCzU36DN6CCDXYwggX0MIID3KADAgECAhMzAAAEBGx0
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBivB4VP3xxa79EUjtugz6U4
# p3unxkW5ytooFluAvkBZMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAN6UNfLqIEHU+mp0svNX8gju8C8nRz2Vsao5oHaFjXgTNeqv3DHbHwdyu
# JQu0QM3VgfYxKYILUmDKWUUSiMURQ5eF/3sHBdhV+Gd3u9AX3mNliA8/r3xVW6ea
# PrkQvLR+j7U86N9PAc14nV1SObx0EVtr9A3sQuc1y1J0FDBbHxXrN/lgsA6ypbmv
# YMstQhg5ocRSNjpaXftzLvmumcNFws/ki/ZTfLCvBcMZDMaEDov1LzH4HbqmQdMT
# Qdw8JT2TjWe5/9oxt466r6F1iXg0e2IzkQql1ZPBZwFBag1GIoGjsYQF16c1U/P3
# wxA/blZAt1aTBb/T8yN0S6Amyeeq0aGCF7AwghesBgorBgEEAYI3AwMBMYIXnDCC
# F5gGCSqGSIb3DQEHAqCCF4kwgheFAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFaBgsq
# hkiG9w0BCRABBKCCAUkEggFFMIIBQQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCDHu9KsPuDNpJXe00ikEE7rdSSNOWKVZRufwJ3N6ots8gIGZ0nWeG2M
# GBMyMDI0MTIwOTE4Mjk1Ny4xMjhaMASAAgH0oIHZpIHWMIHTMQswCQYDVQQGEwJV
...
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQg6y5CLKxI
# 4AwW3fCVAJFGBKK6dno7msxCeBbdssOdJQUwgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# DQEBCwUABIICABGjncGEa/nPCF3GG1sBiLUZThHoSiOASo25muTJxnWOI8lOkzV0
# js0x0GaZn6RLCc24tvw+byaHzu3hcyAXCzFOEiOkhvkxX28f5p7ADltKWUae3POt
# 7k8rWgAbsF48LSSOQ9f2r/VNgpbx2vqNv2LVo/wYvN1C0tKkyN1QjHNpAsoZuyjp
# CcAcNcMaqLBf1Djtl7O2EIJxw3iODP3UexMEP0/xjV3OBpYR3xtciJGvhvVqhm2V
# 3Q5juhWZJuAdhEqr6P1jivCvHAVUPS0YDwxvNRkjKKZLbt9C5ndtEnDzjc+PTxGs
# Tw1OAg7bDKv1LCQ9OIdFdul0ksfQY6Gsu01L9buN+kOGtX5j+zNuFH8XbtEinqih
# BeN1qTjCXdXw/BJIQ82ZgEXlOX6bUnxANYf4Euc9mxt9p4IzJuYxlEiFHmYtK7wl
# uM297H1OVkV02u2XzlfxuJUIzUpWM2vPOFl+1kR5V6Wg4chqtOjv7p47fftOR2pm
# IRif1aC70kko3SC+fhRgsRrkAymI13Czihq8KKGe6pTqtt5VQw6798eGOMT678SH
# hU+y63LRLveR1N9g2bta9T+wtMw+rTbMB8ePO+K7TR7wvXn0am/9HXCKVauXxt28
# 5uZ27TsA8QpE/r3yLtf6+4pJN9Ja6vVU2TGsu8LwVuIK45oC++1iVWZu
