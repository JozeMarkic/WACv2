...
AadRegistrationSettingsReviewGuideMessage=Agregue un URI de redirección adicional con la ruta de acceso local "/signin-oidc" (por ejemplo, https://wac-portal-site.contoso.com/signin-oidc) en el registro de la aplicación de Azure para habilitar el inicio de sesión de Azure AD.
AadRegistrationSettingsReviewMessage=App de Azure configuración de registro debe revisarse después de la migración.
AlreadyPerformedMessage=Parece que ya se ha realizado la migración.
BindingRemovedMessage=Se quitó el enlace de puerto HTTP de Windows Admin Center V1; para recuperar Windows Admin Center V1, desinstale Windows Admin Center V2 y use Restore-WACV1Environment.
CannotFindFileMessage=No se encuentra el archivo en {0}
CompletedEndGuideMessage=No queda ninguna tarea.
CompletedMigrationMessage=Migración completada. El último estado se ha guardado en {0} y {1}.
CompletedReviewGuideMessage=Vea las tareas restantes {0} del archivo '{1}'.
CompletedReviewMessage=La migración se ha completado.
...
ExtensionInstallationReviewMessage=El paquete de extensión debe instalarse después de la migración.
ForcedMessage=Se forzó la repetición de la migración. Revise lo que faltaba en la migración anterior una vez.
MigratedPreInstalledCertifateMessage=Los certificados preinstalados se han migrado desde WACv1.
MigrationStartMessage=La migración requiere que Windows Admin Center V2 esté preinstalada y configurada, y no se desinstalará Windows Admin Center V1.
MigrationStartMessage1= 1) En caso de transferir el mismo número de puerto en el modo de autenticación de Windows (NTLM), quitará el enlace de puerto HTTP de Windows Admin Center V1 y, si necesita recuperar Windows Admin Center V1, puede usar el comando Restore-WACV1Environment.
MigrationStartMessage2= 2) La migración restablecerá Windows Admin Center V2 para las categorías seleccionadas y podría sobrescribir y quitar los datos actuales de Windows Admin Center V2. Hay dos categorías, como la configuración y la base de datos. Puede omitir de forma interactiva una categoría en los mensajes de solicitud.
MigrationTitle=Migrando a Windows Admin Center V2. (NonInteractive: {0})
MigrationWasNotMessage=Aún no se ha realizado la migración en el sistema.
NoLabel=&No
...
NotFoundV2Message=Windows Admin Center V2 no está instalado. Debe preinstalar manualmente Windows Admin Center V2. Use un número de puerto temporal, el número de puerto original de la transferencia de migración a Windows Admin Center V2.
...
OlderV1Message=Hay una versión antigua de Windows Admin Center V1 instalada. Antes de la migración, debe actualizar a la versión más reciente de Windows Admin Center V1.
OlderV2Message=Hay una versión antigua de Windows Admin Center V2 instalada. Antes de la migración, debe actualizar a la versión más reciente de Windows Admin Center V2.
PathNotJsonMessage=La ruta de acceso debe ser un archivo JSON: {0}
PortMigratedMessage=Se migró el enlace de puerto en WindowsAuthentication.
ProxySettingsReviewGuideMessage=Visite el menú configuración del proxy de Internet en Windows Admin Center interfaz de usuario para volver a configurar un proxy con credenciales.
ProxySettingsReviewMessage=La configuración del proxy debe revisarse después de la migración.
QuitAllMessage=Salir de todo
QuitLabel=&Salir
QuitMigrationMessage=Salga de la migración. Se ha cancelado la transferencia.
SaveStateV1Message=Se guardó el estado de Windows Admin Center V1 y V2 en {0}
SelfSignedSubjectNameMessage=Windows Admin Center está usando un certificado autofirmado. La migración usa el certificado autofirmado actual, SubjectName={0}.
SkipDatabaseMessage=Omitir la actualización de la base de datos.
SkipLabel=&Omitir
SkipSettingsMessage=Omitir la actualización de la configuración y las opciones.
StatusTitleCannotRepeat=No se puede repetir la migración
StatusTitleNotApplicable=La migración no está disponible en el sistema
StatusTitleNotReady=La migración no está lista en el sistema
StatusTitlePartial=La migración se completó parcialmente en el sistema
StatusTitleReady=La migración está lista en el sistema
StopV1ProceedMessage=Detenga Windows AdminCenter V1 y continúe con la migración.
StopWindowsAdminCenterV1Message=Empiece a guardar el estado actual, se detendrá Windows Admin Center V1.
SureProceedMessage=¿Seguro que deseas continuar?
TransferReadyMessage=Transfiriendo todos los datos de configuración de V1 ({0}) a V2 ({1})
TransferringStatusMessage=Transfiriendo: (Configuración: {0}), (Base de datos: {1})
...
UpdateSettingsMessage=Actualice la configuración y las opciones.
UpdatingDatabaseMessage=Actualizando y restableciendo el contenido de la base de datos. Esto podría sobrescribir y quitar los datos existentes, incluido el registro de App de Azure de Windows Admin Center V2.
UpdatingSettingsMessage=Actualizando la configuración y la configuración. Si selecciona, la migración transferirá el número de puerto a Windows Admin Center V2.
V1InstallErrorMessage=Windows Admin Center V1 no se ha inicializado correctamente, debe usar Windows Admin Center V1 al menos una vez después de instalar o actualizar para inicializar su entorno. Windows Admin Center V1 se migrará parcialmente sin la configuración de extensiones.
...
WebSocketSettingsReviewGuideMessage=Agregue manualmente todos los orígenes permitidos en WebSocketAllowedOrigins del archivo %Program Files%\\WindowsAdminCenter\\Service\\appsettings.json. Establezca todos los valores de encabezado de origen permitidos para las solicitudes WebSocket para evitar el secuestro de WebSocket entre sitios. De forma predeterminada, se permiten todos los orígenes.
WebSocketSettingsReviewMessage=La configuración de WebSocket debe revisarse después de la migración.
WindowAuthenticationMessage=Windows Admin Center V2 está configurado con autenticación de Windows (NTLM). Para migrar el puerto, quitará el enlace de puertos de Windows Admin Center V1. Puede recuperarlo mediante Restore-WACV1Environment tras desinstalar Windows Admin Center V2.
YesLabel=&Sí
'@
